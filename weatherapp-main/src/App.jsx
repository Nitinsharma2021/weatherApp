...
const Api_key = "7811cd3224455d9dcf7143793c36f929";
...
const App = () => {
  ...
  const fetchWeather = async () => {
    const URL = `https://api.openweathermap.org/data/2.5/weather?q=${inputRef.current.value}&units=metric&appid=7811cd3224455d9dcf7143793c36f929`;
    setLoading(true);
    fetch(URL)
      .then((res) => res.json())
      .then((data) => {
    ...
    <>
      <div class="absolute w-full text-center">
        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
          <div class="text-blue-600 dark:text-blue-500">Live Weather</div>
        </h1>
      </div>
